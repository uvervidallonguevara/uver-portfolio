...
import { Code2, Cpu, Wrench, Lightbulb, Award } from "lucide-react";
      ...
      <header className="fixed top-0 inset-x-0 z-50 backdrop-blur-xl bg-background/50 border-b border-border">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <nav className="hidden sm:flex gap-7 text-sm text-muted-foreground">
            ...
            <a href="#resume" className="hover:text-primary transition story-link">Resume</a>
          ...
          <div className="grid lg:grid-cols-[1fr_auto] gap-2 lg:gap-4 items-start">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed text-justify hyphens-auto">
                <p>
                  I tend to focus on building things that actually solve something, rather than getting
                  caught up in labels. From apps like mental health tools to small systems and utilities,
                  I enjoy figuring out how ideas can become something real and usable.
                </p>
                <p>
                  I usually work in a fast, experimental way—trying things out early, refining as I go,
                  and learning from what breaks. Most of my progress comes from iteration and actually
                  seeing how people interact with what I build.
                </p>
                <p>
                  I'm still exploring where this all leads, but I keep coming back to the same pattern:
                  building, adjusting, and learning through the process of creating.
                </p>
              </div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <Link
                  to="/certificates"
                  className="inline-flex items-center gap-2 rounded-xl border border-border bg-secondary/40 backdrop-blur px-6 py-3 text-sm font-medium hover:border-primary hover:bg-secondary/60 transition"
                >
